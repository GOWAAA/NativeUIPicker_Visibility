...
const object = [];
//Enter no. of object you wish to toggle visibility with native UI picker
const object_no = 4

// Find your objects 
//make sure you name your object in order back in Spark AR starting from 0
//e.g Object0, Object1, Object2 etc...
for(let i = 0; i<object_no; i++){
    //Add all objects you want into the empty list you created above
    //Only objects you name in the format "object0" will be added, so make sure you don't have other object name this way in SparkAR to
    //avoid adding the wrong things here. Also, we count starting from 0 here!
    object.push(Scene.root.find('object'+i)); 
}
